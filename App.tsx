...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'schemes': return <SchemeDiscovery language={language} />;
      case 'grievances': return <GrievancePortal language={language} />;
      case 'welfare': return <WelfareTracker language={language} />;
  ...
  const getPageTitle = () => {
    switch (activeTab) {
      ...
      case 'schemes': return t.schemesTitle;
      case 'grievances': return t.grievancesTitle;
      case 'welfare': return t.welfareTitle;
        ...
        <header className="px-10 py-8 flex justify-between items-center sticky top-0 bg-slate-50/80 backdrop-blur-xl z-40 border-b border-slate-100">
          ...
          <div className="flex items-center space-x-6">
            ...
            >
                ...
                <div>
                  <p className="text-xs font-black text-slate-800 leading-none">Kumar, Sandeep</p>
